...
L<MooseX::RememberHisory> provides an attribute trait (C<RememberHistory>) which will automagically store the values of that attribute in a related ArrayRef on each write to the attribute.
